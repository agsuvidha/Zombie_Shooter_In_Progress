class Zombie {
    constructor(x, y, w, h, pos) {
        var options = {
            ...
            // this.zombie;
//            this.zombieImg = loadAnimation("assets/male/Walk(1).png", "assets/male/Walk(2).png", "assets/male/Walk(3).png", "assets/male/Walk(4).png", "assets/male/Walk(5).png", "assets/male/Walk(6).png", "assets/male/Walk(7).png", "assets/male/Walk(8).png", "assets/male/Walk(9).png", "assets/male/Walk(10).png");
